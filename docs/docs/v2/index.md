# DigiLEAN Connect API V2 (Beta)

## General info

DigiLEAN Connect API V2 is a REST API with [OData](https://www.odata.org)

Documentation of the operations are listed in the menu. 

You can also access the full 
<a href="/swagger/v2/swagger.json" target="_blank">OpenAPI spec</a>
...
<table>
    <tbody>
        <tr>
            ...
            <td>
                https://connect.digilean.tools/v2
            </td>
        </tr>
        <tr>
            <td>
